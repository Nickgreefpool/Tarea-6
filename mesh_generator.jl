function make_model(grid_type,p)
    ...
    if grid_type == "circle"
        ...
        #lc = lc/4
        gmsh.model.geo.addPoint(0, 0, 0, lc, 1)
        gmsh.model.geo.addPoint(0 + cy_radious, 0, 0, lc, 2)
        gmsh.model.geo.addPoint(0 , cy_radious, 0, lc, 3)
        gmsh.model.geo.addPoint(0 - cy_radious, 0, 0, lc, 4)
        gmsh.model.geo.addPoint(0 , - cy_radious, 0, lc, 5)
        ...
        #gmsh.model.geo.addPhysicalGroup(1, [10], 11 )
        gmsh.model.geo.addPhysicalGroup(1, [1, 2, 3, 4], 11 )
        gmsh.model.setPhysicalName(1, 11, "cir")
        gmsh.model.geo.synchronize()
        ...
        gmsh.finalize()
        model = GmshDiscreteModel("models/circle.msh")
    end
